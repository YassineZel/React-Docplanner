...
let ServicesItems = [{
  ...
  option: ['CHOOSE COUNTRY', 'Argentina', 'Australia', 'Brazil', 'Chile', 'Colombia', 'czech', 'France', 'Italie', 'Mexico', 'Peru', 'Poland', 'Portugal', 'Spain', 'Turkey', 'UK'],
},
{
  forpatients: false,
  title: 'For doctors',
...
let IntroItems = [
  {
    source: "https://www.docplanner.com/img/sygnet.png",
    title: "Making the healthcare experience more human"
    ,
    pg1: "We want patients to find the perfect doctor and book an appointment in the most easy way. The patient journey should be enjoyable, and that's why we are always next to them: to help them find the best possible care. Anytime, anywhere.",
    pg2: "We also help doctors to better manage their practice and build their online reputation. With our integrated end-to-end solution, doctors are able not only to improve their online presence, but also to devote their time to what really matters: their patients.",
...
let OfficesItems1 = [
  {
    ...
    text: "More than 1000 team mates share our same vision, goals and passion. With offices in Warsaw, Barcelona, Istanbul, Rome, Mexico City and Curitiba, our search for great talent never stops.",
    ...
    <div className="App">
      <div className="Header">
        ...
        <div className="Header-menu">
          {
            items.map(el => <Header data={el} />)
          }
        </div>
      </div>
      <div className="intro">
        {IntroItems.map(el => <Intro data={el} />)}
      </div>
      <div className="Services-doctors">
        {
          ServicesItems.map(el => <Services data={el} />)
        }
      </div>
      <div className="Brands">
        <h1 className="Brands-title">We are a global company  with local culture </h1>
        <div className="Brands-logo">
          {
            logo.map(el => <Brands data={el} />)
          }
        </div>
      </div>
      <div className="Etat">
        <div className="Etat-title">
          {EtatItems1.map(el => <Etat data={el} />)}
        </div>
        <div className="Etat-items">
          {EtatItems2.map(el => <Etats data={el} />)}
        </div>
      </div>
      <div className="Offices">
        <div className="offices-description">
          {OfficesItems1.map(el => <Officestitle data={el} />)}
        </div>
        <div className="offices-section">
          {OfficesItems2.map(el => <Offices data={el} />)}
        </div>
      </div>
      <Footer />
    </div>
